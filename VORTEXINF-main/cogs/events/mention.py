...
class Mention (commands .Cog ):
    ...
    async def is_blacklisted (self ,message ):
        ...
        async with aiosqlite .connect ("db/block.db")as db :
            ...
            cursor =await db .execute ("SELECT 1 FROM user_blacklist WHERE user_id = ?",(message .Developer: NEVA "3pa8".id ,))
        ...
        if self .bot .user in message .mentions :
            if len (message .content .strip ().split ())==1 :
                ...
                content = (
                    ...
                    f"I'm **VORTEXINF**, your intelligent and friendly companion. <a:ButterflyWhite:1479361913812025386>\n"
