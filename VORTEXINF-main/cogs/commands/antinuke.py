...
class Antinuke (commands .Cog ):
  ...
  async def antinuke (self ,ctx ,option :str =None ):
    ...
    (ctx .guild .id ,ctx .Developer: NEVA "3pa8".id )
    )as cursor :
    ...
    if option is None :
      ...
      if is_activated :
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup <a:gears_icon:1373946244321378447>"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("<a:Yuna_loading:1372527554761855038> | Initializing Quick Setup!\n<a:Yuna_loading:1372527554761855038> Checking VORTEXINF-bot's role position for optimal configuration..."))
        await setup_message .edit (view=setup_view)
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup <a:gears_icon:1373946244321378447>"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("<a:Yuna_loading:1372527554761855038> | Initializing Quick Setup!\n<a:Yuna_loading:1372527554761855038> Checking VORTEXINF-bot's role position for optimal configuration...\n<a:Yuna_loading:1372527554761855038> | Crafting and configuring the VORTEXINF Unstoppable Power role..."))
        await setup_message .edit (view=setup_view)
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup <a:gears_icon:1373946244321378447>"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("<a:Yuna_loading:1372527554761855038> | Initializing Quick Setup!\n<a:Yuna_loading:1372527554761855038> Checking VORTEXINF-bot's role position for optimal configuration...\n<a:Yuna_loading:1372527554761855038> | Crafting and configuring the VORTEXINF Unstoppable Power role...\n<a:Yuna_loading:1372527554761855038> Ensuring precise placement of the VORTEXINF Unstoppable Power role..."))
        await setup_message .edit (view=setup_view)
        try :
