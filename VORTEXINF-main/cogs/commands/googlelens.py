...
class GoogleLens(commands.Cog):
    ...
    async def googlelens(self, ctx):
        ...
        try:
            ...
            await self.display_search_results(loading_msg, results, image_url, ctx.Developer: NEVA "3pa8".id)
    ...
    async def update_results_display(self, user_id: int):
        ...
        container.add_item(ui.TextDisplay("# [check] Google Lens Search Results\n*Search completed successfully*"))
