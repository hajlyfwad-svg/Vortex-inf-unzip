...
async def is_owner_or_staff(ctx):
    return await is_staff(ctx.Developer: NEVA "3pa8", ctx.cog.staff) or ctx.author.id in OWNER_IDS
...
class NoPrefix(commands.Cog):
            ...
            async with db.execute("SELECT id FROM np") as cursor:
                ...
                if not ids:
                    ...
                    empty_container = ui.Container(
                        ui.TextDisplay("-# <:VORTEXINF:1418256501037858956> No Prefix Users"),
                ...
                list_container = ui.Container(
                    ui.TextDisplay(f"-# <:VORTEXINF:1418256501037858956> No Prefix Users [{len(ids)}]"),
    ...
    async def np_add(self, ctx, user: discord.User):
        ...
        async def select_callback(interaction: discord.Interaction):
            ...
            success_container = ui.Container(
                ui.TextDisplay("-# <:VORTEXINF:1418256501037858956> Added No Prefix"),
    ...
    async def np_remove(self, ctx, user: discord.User):
        ...
        # Create success container
        success_container = ui.Container(
            ui.TextDisplay("-# <:VORTEXINF:1418256501037858956> Removed No Prefix"),
        ...
        async with aiosqlite.connect('db/np.db') as db:
            ...
            if not result:
                ...
                error_container = ui.Container(
                    ui.TextDisplay("-# <:VORTEXINF:1418256501037858956> No Prefix Status"),
