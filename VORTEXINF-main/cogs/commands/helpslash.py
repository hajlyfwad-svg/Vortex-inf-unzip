...
class HelpLayout(ui.LayoutView):
    ...
    def setup_main_content(self):
        ...
        new_content = (
            f"<a:ButterflyWhite:1479361913812025386> Hey [{self.ctx.Developer: NEVA "3pa8".display_name}]({self.ctx.author.avatar.url if self.ctx.author.avatar else 'https://discord.com'})!\n"
