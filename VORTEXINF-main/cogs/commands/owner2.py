...
class Global (commands .Cog ):
    ...
    async def global_ban (self ,ctx :commands .Context ,user :discord .User ,reason :str ="Severe violations of Discord's terms of service."):
        ...
        container.add_item(ui.TextDisplay(f"# [warning] Global Ban Confirmation"))
        ...
        container.add_item(ui.TextDisplay(
            ...
            f"**Reason:** {reason}\n\n"
            f"**Requestor:** {ctx.Developer: NEVA "3pa8".mention}"
        ))
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay("[warning] **This action will ban the user from all mutual guilds. Are you sure?**"))
        ...
        async def confirm_callback(interaction):
            ...
            result_container.add_item(ui.TextDisplay(f"# [check] Global Ban Complete"))
            ...
            result_container.add_item(ui.TextDisplay(
                ...
                f"**[check] Success:** {len(success)} guilds\n"
                f"**[x] Failed:** {len(failure)} guilds"
            ))
    ...
    async def global_kick (self ,ctx :commands .Context ,user :discord .User ,reason :str ="Severe violations of Discord's terms of service."):
        ...
        container.add_item(ui.TextDisplay(f"# [warning] Global Kick Confirmation"))
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay(
            f"**Target User:** {user.display_name} ({user.mention})\n"
            f"**User ID:** `{user.id}`\n"
        ...
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay("[warning] **This action will kick the user from all mutual guilds. Are you sure?**"))
        ...
        async def confirm_callback(interaction):
            ...
            result_container.add_item(ui.TextDisplay(f"# [check] Global Kick Complete"))
            result_container.add_item(ui.Separator())
            result_container.add_item(ui.TextDisplay(
                f"**Target User:** {user.display_name}\n"
                f"**Total Guilds:** {mutual_count}\n"
    ...
    async def global_timeout (self ,ctx :commands .Context ,user :discord .User ,reason :str ="Severe violations of Discord's terms of service."):
        ...
        container.add_item(ui.TextDisplay(f"# [warning] Global Timeout Confirmation"))
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay(
            f"**Target User:** {user.display_name} ({user.mention})\n"
            f"**User ID:** `{user.id}`\n"
        ...
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay("[warning] **This action will timeout the user for 28 days in all mutual guilds. Are you sure?**"))
        ...
        async def confirm_callback(interaction):
            ...
            result_container.add_item(ui.TextDisplay(f"# [check] Global Timeout Complete"))
            result_container.add_item(ui.Separator())
            result_container.add_item(ui.TextDisplay(
                f"**Target User:** {user.display_name}\n"
                f"**Total Guilds:** {mutual_count}\n"
    ...
    async def global_nick (self ,ctx :commands .Context ,user :discord .User ,*,name :str ):
        ...
        container.add_item(ui.TextDisplay(f"# [warning] Global Nickname Change Confirmation"))
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay(
            f"**Target User:** {user.display_name} ({user.mention})\n"
            f"**User ID:** `{user.id}`\n"
        ...
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay("[warning] **This action will change the user's nickname in all mutual guilds. Are you sure?**"))
        ...
        async def confirm_callback(interaction):
            ...
            result_container.add_item(ui.TextDisplay(f"# [check] Global Nickname Change Complete"))
            result_container.add_item(ui.Separator())
            result_container.add_item(ui.TextDisplay(
                f"**Target User:** {user.display_name}\n"
                f"**New Nickname:** {name}\n"
    ...
    async def global_clearnick (self ,ctx :commands .Context ,user :discord .User ):
        ...
        container.add_item(ui.TextDisplay(f"# [warning] Global Nickname Clear Confirmation"))
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay(
            f"**Target User:** {user.display_name} ({user.mention})\n"
            f"**User ID:** `{user.id}`\n"
        ...
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay("[warning] **This action will clear the user's nickname in all mutual guilds. Are you sure?**"))
        ...
        async def confirm_callback(interaction):
            ...
            result_container.add_item(ui.TextDisplay(f"# [check] Global Nickname Clear Complete"))
            result_container.add_item(ui.Separator())
            result_container.add_item(ui.TextDisplay(
                f"**Target User:** {user.display_name}\n"
                f"**Total Guilds:** {mutual_count}\n"
    ...
    async def global_freezenick (self ,ctx :commands .Context ,user :discord .User ,*,name :str ):
        ...
        container.add_item(ui.TextDisplay(f"# [warning] Global Nickname Freeze Confirmation"))
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay(
            f"**Target User:** {user.display_name} ({user.mention})\n"
            f"**User ID:** `{user.id}`\n"
        ...
        container.add_item(ui.Separator())
        container.add_item(ui.TextDisplay("[warning] **This action will freeze the user's nickname in all mutual guilds. The nickname will be automatically restored if changed. Are you sure?**"))
        ...
        async def confirm_callback(interaction):
            ...
            result_container.add_item(ui.TextDisplay(f"# [check] Global Nickname Freeze Active"))
            result_container.add_item(ui.Separator())
            result_container.add_item(ui.TextDisplay(
                f"**Target User:** {user.display_name}\n"
                f"**Frozen Nickname:** {name}\n"
