...
if TYPE_CHECKING :
    ...
    Board :TypeAlias =list [list [Optional [Literal ["[lightbulb]"]]]]

BULB :Final [Literal ["[lightbulb]"]]="[lightbulb]"
...
class LightsOutView (discord .ui .LayoutView ):
    ...
    def setup_view (self ):
        ...
        container .add_item (discord .ui .TextDisplay ("# [lightbulb] Lights Out"))
...
class LightsOut :
    ...
    *,
    ...
    timeout :Optional [float ]=None ,
        ...
        self .player =ctx .Developer: NEVA "3pa8".tiles =random .choices ((None ,BULB ),k =self .count **2 )
